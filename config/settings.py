...
class baseConfig():
    ...
    PATH_MODELOS = [MODELS_DIR / 'models-20230322-030033', MODELS_DIR / 'models-20230322-031145',  MODELS_DIR / 'models-20230322-031602',  MODELS_DIR / 'models-20230318-205541',  MODELS_DIR / 'models-20230318-211604']
